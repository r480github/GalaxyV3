...
import { Context, ParserState, PropertyKind, Origin, Flags, OnComment, OnInsertedSemicolon, OnToken, BindingKind, HoistedClassFlags, HoistedFunctionFlags, ScopeState, PrivateScopeState } from './common';
...
export declare function parseBlock(parser: ParserState, context: Context, scope: ScopeState | undefined, privateScope: PrivateScopeState | undefined, labels: ESTree.Labels, start: number, line: number, column: number): ESTree.BlockStatement;
...
export declare function parseBinaryExpression(parser: ParserState, context: Context, privateScope: PrivateScopeState | undefined, inGroup: 0 | 1, start: number, line: number, column: number, minPrec: number, operator: Token, left: ESTree.ArgumentExpression | ESTree.Expression): ESTree.ArgumentExpression | ESTree.Expression;
...
export declare function parseMembeExpressionNoCall(parser: ParserState, context: Context, privateScope: PrivateScopeState | undefined, expr: ESTree.Expression, inGroup: 0 | 1, start: number, line: number, column: number): any;
...
export declare function parsePropertyDefinition(parser: ParserState, context: Context, privateScope: PrivateScopeState | undefined, key: ESTree.PrivateIdentifier | ESTree.Expression | null, state: PropertyKind, decorators: ESTree.Decorator[] | null, start: number, line: number, column: number): ESTree.PropertyDefinition | ESTree.AccessorProperty;
